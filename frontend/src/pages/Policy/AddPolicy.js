...
const AddPolicy = () => {
  ...
  const handlePolicyTitleChange = (e) => {  
    ...
    // Remove any negative values from the policy title
    const updatedValue = value.replace(/^-/, "");
    setPolicyTitle(updatedValue);
  };
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <Typography variant="h4" sx={{ marginLeft: "200px" }}>
            Create Policy
          </Typography>
          <TextField
            label="Policy Title"
          ...
          <Button
            ...
            variant="contained"
            color="primary"
            sx={{ width: "200px", backgroundColor: "#8fbc8f " }}
          >
            Create Policy
          </Button>
        </Box>
